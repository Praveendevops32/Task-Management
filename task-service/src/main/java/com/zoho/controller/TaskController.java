...
import com.zoho.model.TaskStatus;
import com.zoho.model.UserDto;
import com.zoho.service.TaskService;
...
public class TaskController {
    ...
    public ResponseEntity<List<Task>> getAssignedUsersTask(
        ...
        List<Task> tasks = taskService.assignedUsersTask((long) user.getId(),status);
    ...
    public ResponseEntity<Task> updateTask(
        ...
        Task tasks = taskService.updateTask(id,req, (long) user.getId());
